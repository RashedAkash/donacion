<?php 
   ...
   $donacion_menu_col = $donacion_header_right ? 'col-xxl-6 col-xl-6 col-lg-8 d-none d-lg-block' : 'col-xxl-9 col-xl-9 col-lg-8 d-none d-lg-block text-end';
   $header_search_switch = get_theme_mod( 'header_search_switch', false );

   //Phone
   $header_top_phone = get_theme_mod( 'header_phone', __( '+880190678956', 'donacion' ) );
   $header_top_time = get_theme_mod( 'header_top_time', __( 'Sunday - Friday: 9 am - 8 pm', 'donacion' ) );
   $header_top_menu = get_theme_mod( 'header_top_menu', __( 'top menu', 'donacion' ) );
   
   // Email id 
   $header_top_email = get_theme_mod( 'header_email', __( 'donacion@support.com', 'donacion' ) );
   $donacion_sticky_logo = get_theme_mod( 'header_sticky_logo', get_template_directory_uri() . '/assets/img/logo/logo-white.png' );
   // Header Address Text
   $header_top_address_text = get_theme_mod( 'header_address', __( '734 H, Bryan Burlington, NC 27215', 'donacion' ) );

   // Header Address Link
   $header_address_link = get_theme_mod( 'header_address_link', __( '#', 'donacion' ) );
                        ...
                        <div class="col-xxl-7 col-xl-9">
                            <div class="tp-header-top-info-3">
                                <ul>
                                    ...
                                    <li>
                                        <a href=""><span><i
                                                    class="fa-solid fa-clock"></i></span><?php echo esc_html__("Sunday - Friday:","donacion") ?><b><?php echo esc_html( $header_top_time ); ?></b></a>
                                    </li>
                                    <?php endif; ?>
                                </ul>
                            </div>
                        ...
                        <div class="col-xxl-5 col-xl-3">
                            <div class="tp-header-top-right-3 d-flex justify-content-end align-items-center">
                                ...
                                <div class="tp-header-top-support d-xxl-flex d-none">
                                    <?php echo donacion_kses( $header_top_menu ); ?>
                                </div>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="col-xxl-6 col-xl-7 col-6">
                            <div class="tp-main-menu home-3 align-items-center justify-content-between d-flex">
                                <div class="tp-main-menu-logo d-block d-xl-none">
                                    <?php donacion_header_black_logo(); ?>
                                </div>
                                <div class="d-none d-xl-flex">
                                    <nav class="tp-main-menu-content">
                                        <?php donacion_onepage_menu_01(); ?>
                                    </nav>
                                </div>
                            </div>
                        </div>
