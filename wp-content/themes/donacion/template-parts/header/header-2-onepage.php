<?php 
	...
	*/
	 ...
	 // info
    $donacion_topbar_switch = get_theme_mod( 'header_topbar_switch', false );
   ...
   $header_top_phone = get_theme_mod( 'header_phone', __( '+8801310-069824', 'donacion' ) );
    ...
    // contact button
	$donacion_button_text = get_theme_mod( 'donacion_button_text', __( 'Make Request', 'donacion' ) );
   $donacion_button_link = get_theme_mod( 'donacion_button_link', __( '#', 'donacion' ) );

    // acc button
	$donacion_acc_button_text = get_theme_mod( 'donacion_acc_button_text', __( 'Login', 'donacion' ) );
   $donacion_acc_button_link = get_theme_mod( 'donacion_acc_button_link', __( '#', 'donacion' ) );
  ...
  $header_address_link = get_theme_mod( 'header_address_link', __( '#', 'donacion' ) );
   ...
   $donacion_menu_end = $donacion_header_right ? '' : 'justify-content-end';
   // header search btn 
...
<header class="tp-header-area p-relative">
    <div class="tp-header-box p-relative">
        ...
        <div class="tp-header-wrapper-inner header__sticky p-relative">
            <?php if(!empty($donacion_topbar_switch)) : ?>
        ...
        <?php endif; ?>
        <?php  if ( empty( $donacion_header_right ) ): ?>
        <div class="tp-header-btn d-xl-none">
            <a class="tp-btn d-none d-xl-block"
                href="<?php echo esc_url( $header_top_button_link ); ?>"><?php echo esc_html( $header_top_button_text ); ?><i
                    class="fa-regular fa-arrow-right"></i></a>
            <div class="tp-header-main-right-hamburger-btn d-xl-none offcanvas-open-btn">
