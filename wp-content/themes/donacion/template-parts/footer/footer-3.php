...
*/
    ...
    Newsletter', 'donacion' ) );
    $footer_top_cta = get_theme_mod( 'footer_top_cta', __( 'do shortcode', 'donacion' ) );
...
?>
<!-- footer area start -->
<footer class="tp-footer-area-3  p-relative z-index-1 pt-120" style="<?php echo esc_attr($main_bg); ?>">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-5 col-md-12">
                        <div class="tp-footer-subscribe-wrapper-title d-flex align-items-center">
                            ...
                            <h3 class="tp-footer-subscribe-title"> <?php echo donacion_kses( $footer_top_cta_title ); ?></h3>
                            <?php endif; ?>
                        </div>
                    </div>
